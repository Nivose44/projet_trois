...
"""
class LaunchGame():
    """ That class will create the board and all the object and characters and place them on the board whith the method init and can launch the game with the method launch"""
    def __init__(self, Board, Character, Obj):
        ...
        self.launch()
    def launch(self):
        """launch will create a loop that will call the method movement untill the hero reached the guardian"""
